...
export default defineComponent({
  setup() {
    ...
    // watchEffect(() => {
    //   store.fetchProductsBySearch()
    //   store.totalProductRefetch()
    // })
    ...
    return (
      <div class="relative">
        ...
        <div class="flex flex-col">
          <div class="product-list w-full flex-1 max-h-[750px] overflow-x-auto min-h-[610px] bg-gray-100 dark:bg-gray-800">
                ...
                <tbody>
                  {store.products.map((product: any, index: number) => {
                    ...
                    return (
                      <tr
                        key={product.id}
                        class="bg-[#fff] dark:bg-gray-800 dark:border-gray-700 border-b hover:bg-blue-50 dark:hover:bg-gray-600 hover:cursor-pointer h-[56px]"
                      >
                        <th
                          scope="row"
